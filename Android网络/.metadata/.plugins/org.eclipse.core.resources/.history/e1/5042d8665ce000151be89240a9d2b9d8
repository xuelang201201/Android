...
public class MainActivity extends Activity {
	 ...
	 * @throws IOException
	 */
	private void sendByPost() throws IOException {
	...
	private void sendByGet() throws IOException {
		...
		String url = "http://172.16.44.131:8080/android_day02_jsp/loadFlight.jsp"+(date.equals("")?"":"?date="+date);
