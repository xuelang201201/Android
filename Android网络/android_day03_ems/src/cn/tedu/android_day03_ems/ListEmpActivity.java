...
public class ListEmpActivity extends Activity implements View.OnClickListener {
	...
	private void setViews() {
		...
		tvToAdd = (TextView) findViewById(R.id.tv_list_to_add);
		tvToAdd.setOnClickListener(this);
	}

	@Override
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.tv_list_to_add:
			Intent intent = new Intent(ListEmpActivity.this, AddEmpActivity.class);
