 ...
 * Original file: D:\\workspace_1512_part2\\跨进程绑定Service-服务端\\src\\cn\\tedu\\aidl_server\\IMusicPlayer.aidl
 */
...
case TRANSACTION_getDuraton:
{
data.enforceInterface(DESCRIPTOR);
long _result = this.getDuraton();
reply.writeNoException();
...
@Override public long getDuraton() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getDuraton, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_getDuraton = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getMusic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
}
public void play() throws android.os.RemoteException;
public void pause() throws android.os.RemoteException;
public long getDuraton() throws android.os.RemoteException;
